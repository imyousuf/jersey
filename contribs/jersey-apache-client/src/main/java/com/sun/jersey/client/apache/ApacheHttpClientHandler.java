...
public final class ApacheHttpClientHandler extends TerminatingClientHandler {
   ...
   */
  public ApacheHttpClientHandler(HttpClient client, ClientConfig clientConfig) {
    this.client = client;
    methodProcessor = DefaultApacheHttpMethodProcessor.getProcessorInstance(client, clientConfig);
  }
  ...
  public ClientResponse handle(final ClientRequest cr)
    ...
    methodProcessor.executeMethod(method, cr);
